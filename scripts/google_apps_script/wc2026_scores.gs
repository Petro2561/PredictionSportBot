/**
 * ЧМ-2026: счёт с championat.com → листы «Стадия 1», «Стадия 2» и «Стадия 3»
 *
 ...
 *
 * Календарь Championat (групповой этап + плей-офф) — один HTML-ответ:
 *   https://www.championat.com/football/_worldcup/tournament/6858/calendar/
 * Якорь #group в браузере только переключает вкладку; UrlFetchApp его не передаёт,
 ...
 *   Стадия 3: «1/2 финала», «Финал», … (только расписание вверху)
 */
...
const PINNED_SCORES = {
  ...
  'аргентина|швейцария': { home: 1, away: 1 },
  'норвегия|англия': { home: 1, away: 1 },
};
